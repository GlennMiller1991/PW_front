...
import {IStylerPlugin} from "@src/infra/drag-styler/contracts";
import {DragSheetPlugin} from "@src/infra/drag-styler/plugins/drag-sheet.plugin";
...
export class DragStyler {
    ...
    constructor(private dragger: DragMouseController, config?: Partial<IDragStylerConfig>, node?: typeof this.node) {
        this.config = {
